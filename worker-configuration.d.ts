/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b55288ef226bdc7bf17765ed3faa3345)
// Runtime types generated with workerd@1.20260820.1 2026-08-22 
interface __BaseEnv_Env {
	SUPABASE_URL: "https://uethiyubonejuxzzfgiz.supabase.co";
	SUPABASE_PUBLISHABLE_KEY: "sb_publishable_NSF36HAXMcgg3r122qCXEw_jSQ6dtGy";
	VITE_SUPABASE_URL: string;
	VITE_SUPABASE_PUBLISHABLE_KEY: string;
	Game: DurableObjectNamespace<import("./worker/index").GameServer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "GameServer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_URL" | "SUPABASE_PUBLISHABLE_KEY" | "VITE_SUPABASE_URL" | "VITE_SUPABASE_PUBLISHABLE_KEY">> {}
}
